...
"CREATE TABLE IF NOT EXISTS `".$globprefix."player_allyhistory` (
  ...
  `allyhistoryLastAlly` int(10) unsigned DEFAULT NULL DEFAULT 0,
...
"CREATE TABLE IF NOT EXISTS `".$prefix."planeten` (
  ...
  `planetenGateEntf` mediumint(8) unsigned DEFAULT NULL DEFAULT 0,
...
"CREATE TABLE IF NOT EXISTS `".$prefix."systeme` (
  ...
  `systemeGateEntf` mediumint(8) unsigned DEFAULT NULL DEFAULT 0,

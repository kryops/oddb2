...
if(count($fow) OR !$showr) {
	...
	<tr>
		...
		'.($mg['player_allianzenID'] ? fowcell(htmlspecialchars($mg['allianzenTag'], ENT_COMPAT, $charset), false, 0, '/alliances/view/'.$mg['player_allianzenID']) : fowcell('')).'
	...
	<tr>
		...
		'.$inhaber.'
		'.($row['player_allianzenID'] ? fowcell(htmlspecialchars($row['allianzenTag'], ENT_COMPAT, $charset), false, 0, '/alliances/view/'.$row['player_allianzenID']) : fowcell('')).'
